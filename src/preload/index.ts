...
const api: OneSyncAPI = {
  ...
  pickFolder: (): Promise<string | null> =>
    ipcRenderer.invoke(IPC_CHANNELS.DEST_PICK_FOLDER),
  ...
  clearDestination: (): Promise<void> =>
    ipcRenderer.invoke(IPC_CHANNELS.DEST_CLEAR),
  ...
  cancelSync: (): Promise<void> =>
    ipcRenderer.invoke(IPC_CHANNELS.SYNC_CANCEL),
  ...
  verifyIntegrity: (): Promise<void> =>
    ipcRenderer.invoke(IPC_CHANNELS.SYNC_VERIFY_INTEGRITY),

  getFailed: (): Promise<FailedItem[]> =>
    ipcRenderer.invoke(IPC_CHANNELS.DATA_GET_FAILED),

  getRestored: (): Promise<RestoredItem[]> =>
    ipcRenderer.invoke(IPC_CHANNELS.DATA_GET_RESTORED),

  getHistory: (): Promise<SyncRunHistory[]> =>
    ipcRenderer.invoke(IPC_CHANNELS.DATA_GET_HISTORY),
  ...
  openLogs: (): Promise<void> =>
    ipcRenderer.invoke(IPC_CHANNELS.SYSTEM_OPEN_LOGS),

  openAuthorSite: (): Promise<void> =>
    ipcRenderer.invoke(IPC_CHANNELS.SYSTEM_OPEN_AUTHOR_SITE),

  openAbout: (): Promise<void> =>
    ipcRenderer.invoke(IPC_CHANNELS.SYSTEM_OPEN_ABOUT),
